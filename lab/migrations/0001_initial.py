    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valor', models.CharField(blank=True, max_length=128, verbose_name='Resultado analítico')),
                ...
                ('nome_completo', models.CharField(blank=True, max_length=150, verbose_name='Nome completo do Analista')),
                ...
                ('exame', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lab.exame', verbose_name='Exame')),
                ('inserido_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='resultados_inseridos', to=settings.AUTH_USER_MODEL, verbose_name='Analista responsável')),
